...
class Input extends React.Component {
  ...
  render() {
    return(
      <div>
        <label htmlFor={this.props.from}>{this.props.from} to {this.props.to}</label>
...
class Converter extends React.Component {
  ...
  render() {
    ...
    return (
      <form>
        <Input value={emoji} from="emoji" to="ipv4" onChange={this.handleEmojiToIpv4} />
        <Input value={ipv4} from="ipv4" to="emoji" onChange={this.handleIpv4ToEmoji} />
      </form>
    )
  }
}
